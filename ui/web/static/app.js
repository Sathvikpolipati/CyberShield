...
(function init3DCyberGlobe() {
    ...
    function renderGlobe() {
        ...
        // 1. Draw glowing outer globe halo
        ...
        // 3. Draw 3D Longitude Meridian Rings
        for (let m = 0; m < 8; m++) {
        ...
        // 4. Draw Traveling 3D Great-Circle Network Traffic Arcs
        for (let i = globeArcs.length - 1; i >= 0; i--) {
            ...
            // Midpoint elevated in 3D space for true parabolic arc
            ...
            // Interpolate current position along bezier arc
            ...
            if (data.type === 'init') {
                ...
                if (data.new_packets && data.new_packets.length > 0) {
                    for (let i = data.new_packets.length - 1; i >= 0; i--) {
                        ...
                        // Spawn 3D globe beam for new live packet
...
function renderPackets() {
    ...
    // Robust Multi-Vector Protocol Filter
